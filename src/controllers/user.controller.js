...
const logoutUser = asyncHandler(async(req,res) => {
    ...
    const options = { // so cookies get updated only from server
        httpOnly : true,
        secure : true
    }
...
const updateUserAvatar = asyncHandler(async(req,res) => {
    ...
    if(!avatar.url){
        throw new ApiError(400,"Errrow while uploading avatar")
    }
...
const updateUserCoverImage = asyncHandler(async(req,res) => {
    ...
    if(!coverImage.url){
        throw new ApiError(400,"Errrow while uploading cover Image")
    }
